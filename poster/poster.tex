	...
	\begin{minipage}{0.5\linewidth}
		...
		\end{minipage}			
            ...
            \block{Sample Attack}{
                ...
                Suppose there's a \texttt{while}-loop in the firmware, outputing to a pin via an \texttt{OUT} instruction somewhere (Fig.~\ref{loop}). We can count the cycles between successive outputs and use the \texttt{OUT} as our trigger, glitching the desired number of cycles after that.
