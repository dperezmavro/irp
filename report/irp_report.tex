...
\section{Introduction}
	...
	Section \ref{sec:curr_attacks} will give a (brief) overview of the current attack techniques used to override currently implemented proctection mechanisms, an overview of whom is given in Section \ref{sec:defenses}. 
