...
\section{The ATMega MCU Series}
	...
	Atmel released the AVR series on the market in 1996(\cite{book:practical_avr}) and has since been delivering MCUs that are based around the RISC philosophy and have varied capabilities so that developers can find exactly what fits their needs. The AVR family constitutes of the following series\footnote{info:\href{http://en.wikipedia.org/wiki/Atmel_AVR}{http://en.wikipedia.org/wiki/Atmel\_AVR}}:
...
as well as derivatives of the above, including 32-bit AVRs and application specific FPGAs\footnote{AV32 : \href{http://www.atmel.com/products/microcontrollers/avr/default.aspx}{http://www.atmel.com/products/microcontrollers/avr/default.aspx}}.
